...
function ModifySupervisorTimesheet() {
  ...
  async function editTimesheetApproveSave() {
    ...
    try {
      ...
      await axios.put(
        `${serverUrl}/sup/api/working-hours/${id}/approve-range?startDate=${startDate}&endDate=${endDate}&adminId=${adminId}`
      );
  ...
  async function editTimesheetRejectSave() {
    ...
    try {
      ...
      await axios.put(
        `${serverUrl}/sup/api/working-hours/${id}/reject-range?startDate=${startDate}&endDate=${endDate}&reason=${rejectReason}&adminId=${adminId}`
      );
